...
<div tabindex="0" class=" col-1 col-m-1 onclick-menu">
	...
	<ul class="col-12 col-m-12 onclick-menu-content">
			  ...
			  <li><a href="user-pass.jsp">تغییر نام کاربری و گذرواژه</a></li>
			  <li><a href="customer-admin.jsp">لیست کاربر ها</a></li>
			  <li><a href="backup.jsp">ذخیره سازی پایگاه داده</a></li>
	</ul>
</div>
